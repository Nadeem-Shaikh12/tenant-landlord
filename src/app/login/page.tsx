                ...
                <div className="relative z-10 max-w-lg space-y-6">
                    ...
                    >
                        <div className="flex items-start gap-4">
                            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-indigo-600 font-bold shadow-lg">1</div>
                            <p className="text-lg leading-relaxed font-medium">Create your account <br /><span className="text-indigo-200 text-sm font-normal">(Landlord or Tenant)</span></p>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white text-indigo-600 font-bold shadow-lg">2</div>
                            <p className="text-lg leading-relaxed font-medium">Login securely and go to your dashboard</p>
                        </div>
                    </motion.div>
                </div>
            </div>
